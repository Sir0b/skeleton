...
$b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(($this->privates['annotations.cached_reader'] ?? $this->load('getAnnotations_CachedReaderService.php')), [0 => '/app/src/Entity']), 'App\\Entity');
...
$a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
    ...
    'App\\Repository\\PasswordRepository' => ['privates', 'App\\Repository\\PasswordRepository', 'getPasswordRepositoryService.php', true],
