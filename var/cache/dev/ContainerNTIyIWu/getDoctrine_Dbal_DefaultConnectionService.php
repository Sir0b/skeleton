...
return $this->services['doctrine.dbal.default_connection'] = (new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))->createConnection(['dbname' => $this->getEnv('MYSQL_DATABASE'), 'host' => $this->getEnv('MYSQL_HOST'), 'port' => 3306, 'user' => $this->getEnv('MYSQL_USER'), 'password' => $this->getEnv('MYSQL_PASSWORD'), 'driver' => 'pdo_pgsql', 'charset' => 'utf8mb4', 'driverOptions' => [], 'serverVersion' => '11.2', 'defaultTableOptions' => ['charset' => 'utf8mb4', 'collate' => 'utf8mb4_unicode_ci']], $a, $c, []);
